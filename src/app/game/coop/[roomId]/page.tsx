...
export default function CoopGamePage() {
  ...
  const { status: gameStatus, hp, score, combo, orders, currentBurger,
    startGame: startLocalGame, addIngredient, removeLastIngredient, submitBurger } = useGameStore();
  ...
  }, [gameStatus, assignedKeys, addIngredient, removeLastIngredient, submitBurger, sendInput]);
